...
##					  time.sleep(4)
		...
		def parseGame(self, response):
				...
				templateParts = {'part1':'insert ignore into `boxscores` (`gameid`,`teamid`,`playerid`,`year`,', 'part2':[], 'part3':") values ('$gameid','$teamid','$playerid',$year,", 'part4':[],'part5':')'}
				for th in ths:
								...
								for tr in tbody.xpath('.//tr'):
										...
										if isPlayer:
												...
												if len(tds) > 10:
														...
														playerDict = {'gameid':gameid,'teamid':teamid,'playerid':playerid,'year':self._year}
